...
- 🔁 best answer dump in data column
- ✅ tracking 1 and 0 value meaning
- what is this vector capturing (the steer vector used for hallucination detection) and why it can be used for mitigation ?
    - Only Detection is supported by this tsv not steering
- run krutrim-ai-labs/Krutrim-2-instruct and other models to make answers in sentence not one word
- what if we add a reasoning/reasoning information in this steering vector
